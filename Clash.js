...
const customRules = [
  ...
  // ============================================
  // 设计工具 (Figma) - 强制走固定节点，防止 WebSocket 频繁断开
  // Figma 的核心服务多部署在北美 AWS/GCP 节点，直接走美国高品质线路的综合体验（尤其是大文件加载）通常最优。
  // ============================================
  "DOMAIN-SUFFIX,figma.com,US美国",
  "DOMAIN-SUFFIX,figjam.com,US美国",
